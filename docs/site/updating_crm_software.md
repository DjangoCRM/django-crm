...
Therefore, it is important to set up system updates based on new releases of [CRM softwares](https://github.com/DjangoCRM/django-crm/).
...
- Provide meaningful comments on the code you are modifying. This will help in case of conflict when merging your project with a new [Django-CRM releases](https://github.com/DjangoCRM/django-crm/releases).
