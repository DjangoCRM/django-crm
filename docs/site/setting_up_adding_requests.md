...
In [Django CRM](https://github.com/DjangoCRM/django-crm/) you can add commercial requests ("Requests") in manual, automatic and semi-automatic mode.
...
To do this, you need to specify the details of their [mail accounts](setting_up_email_accounts.md) in CRM to ensure CRM access to these accounts.
