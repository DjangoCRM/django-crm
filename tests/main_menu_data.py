...
ADMIN_DATA = [
    ...
    },
    {
        ...
        'app_label': 'quality',
        'app_url': f'/en/{ADMIN_PREFIX}quality/',
        'has_module_perms': True,
        'models': [
            {
                ...
                'add_url': f'/en/{ADMIN_PREFIX}quality/transactionqualityevent/add/',
                'admin_url': f'/en/{ADMIN_PREFIX}quality/transactionqualityevent/',
                'view_only': False
            },
            {
                ...
                'perms': {'add': True, 'change': True, 'delete': True, 'view': True},
                'add_url': f'/en/{ADMIN_PREFIX}quality/transactionqualitysignal/add/',
                'admin_url': f'/en/{ADMIN_PREFIX}quality/transactionqualitysignal/',
                'view_only': False
            }
        ],
    },
