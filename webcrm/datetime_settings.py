...
en_formats.DATE_FORMAT = "m/d/y"            # 10/05/25
en_formats.DATETIME_FORMAT = "m j, Y, P"    # Oct 5, 2025, 1:30 p.m.
en_formats.SHORT_DATE_FORMAT = "m/d/y"      # 10/05/25

es_formats.DATE_FORMAT = "d/m/y"
es_formats.DATETIME_FORMAT = r"j \d\e M \d\e Y à\s H:i"
es_formats.SHORT_DATE_FORMAT = "d/m/y"

fr_formats.DATE_FORMAT = "d/m/y"            # 05/10/25
fr_formats.DATETIME_FORMAT = r"j \d\e M \d\e Y \a \l\a\s H:i"
fr_formats.SHORT_DATE_FORMAT = "d/m/y"      # 05/10/25

it_formats.DATE_FORMAT = "d/m/y"            # 05/10/25
it_formats.DATETIME_FORMAT = "d M Y H:i"    # 05 Ott 2006 14:30
it_formats.SHORT_DATE_FORMAT = "d/m/y"      # 05/10/25

nl_formats.DATE_FORMAT = "j-m-y"            # 5-10-25
nl_formats.DATETIME_FORMAT = "j b Y H:i"    # 5 окт 2006 14:30
nl_formats.SHORT_DATE_FORMAT = "j-m-y"      # 5-10-25

pl_formats.DATE_FORMAT = "d-m-y"            # 05-10-25
pl_formats.DATETIME_FORMAT = "j M Y H:i"    # 5 Paź 2006 14:30
pl_formats.SHORT_DATE_FORMAT = "d-m-y"      # 05-10-25
...
ro_formats.DATE_FORMAT = "j m y"             # 5 10 25
ro_formats.DATETIME_FORMAT = "j b Y, H:i"    # 5 oct 2025, 14:30
ro_formats.SHORT_DATE_FORMAT = "d.m.y"       # 05.10.25
...
tr_formats.DATETIME_FORMAT = "d M Y H:i"    # 5 Eki 2025 14:30
